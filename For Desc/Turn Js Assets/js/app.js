...
//   });
    ...
    const allblogs = document.querySelectorAll('.container5D, .container-9dTabView, .container-a3MobileView');
    allblogs.forEach(blogs => {
      blogs.addEventListener("click", function(){
        window.open("https://niagarairrigationautomation.com/blog-post/", "_blank");
      });
    });
    
    const allvideos = document.querySelectorAll('.container-545D, .container-dcMobileView, .container-d6TabView');
    allvideos.forEach(videos => {
      videos.addEventListener("click", function(){
        window.open("https://niagarairrigationautomation.com/videos/", "_blank");
      });
    });